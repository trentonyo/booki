    ...
    return (
        <div className="datum_frame flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
                <div className="font-bold">Time Remaining:</div><label>{props.datum["gameTimer.remaining"]} <input type="checkbox" name={`${props.frameID}_gameTimer.remaining`} data-datum-value={props.datum["gameTimer.remaining"]}/></label>
                <div className={`font-bold ${extractColor(props.datum["0"])}`}>First Place:</div><label>{props.datum["0"]} <input type="checkbox" name={`${props.frameID}_0`} data-datum-value={props.datum["0"]}/></label>
                <div className={`font-bold ${extractColor(props.datum["1"])}`}>Second Place:</div><label>{props.datum["1"]} <input type="checkbox" name={`${props.frameID}_1`} data-datum-value={props.datum["1"]}/></label>
                <div className={`font-bold ${extractColor(props.datum["2"])}`}>Third Place:</div><label>{props.datum["2"]} <input type="checkbox" name={`${props.frameID}_2`} data-datum-value={props.datum["2"]}/></label>
                <div className={`font-bold ${extractColor(props.datum["3"])}`}>Fourth Place:</div><label>{props.datum["3"]} <input type="checkbox" name={`${props.frameID}_3`} data-datum-value={props.datum["3"]}/></label>
            </div>
